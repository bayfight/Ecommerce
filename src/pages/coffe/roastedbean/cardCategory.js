            ...
            <React.Fragment>
                ...
                <div className="card" style={{ width: "100%" }}>
                    ...
                    <div className="card-body">
                        ...
                        <button className="btn btn-warning"><Link className="text-white" to={`/coffe/detailCategori/${this.state.data.id}`} ><i className="fas fa-shopping-cart"></i> Beli</Link></button>
                    </div>
                </div>
                </div>
